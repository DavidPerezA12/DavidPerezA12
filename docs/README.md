...
Some projects are private, early, or split across more than one repo. These notes are here for the context that would make the profile README too long.
...
- [SurvivorDrive Web](survivordrive-web.md) - Three.js arcade driving prototype with persistent upgrades.

## Setup

- [dotfiles](https://github.com/DavidPerezA12/dotfiles) - the terminal/dev setup that sits underneath most of this work.
